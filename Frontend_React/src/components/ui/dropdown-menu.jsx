...
// componente principal (wrapper) que maneja el estado de apertura
function DropdownMenu({ ...props }) {
  return <DropdownMenuPrimitive.Root data-slot="dropdown-menu" {...props} />;
}

// renderiza el menú en un nodo DOM diferente para evitar problemas de z-index
function DropdownMenuPortal({ ...props }) {
  return (<DropdownMenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />);
}

// botón o disparador sobre el cual se hace clic para abrir el menú
function DropdownMenuTrigger({ ...props }) {
  return (<DropdownMenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} />);
}

// caja flotante que contiene el listado de opciones del menú
...
// agrupa semánticamente varios elementos para navegación por teclado
function DropdownMenuGroup({ ...props }) {
  return (<DropdownMenuPrimitive.Group data-slot="dropdown-menu-group" {...props} />);
}

// opción individual interactiva del menú (ej. variantes default o destructive)
...
// elemento con indicador de verificación tipo checkbox (selección múltiple)
...
// agrupador de ítems de selección única (tipo radio)
function DropdownMenuRadioGroup({ ...props }) {
  return (<DropdownMenuPrimitive.RadioGroup data-slot="dropdown-menu-radio-group" {...props} />);
}

// elemento de selección única tipo radio con indicador de círculo
...
// Título o etiqueta descriptiva de sección no interactiva
...
// Línea divisoria elegante para separar bloques de opciones
...
// texto descriptor de atajo de teclado alineado a la derecha
...
// contenedor principal de submenú anidado
function DropdownMenuSub({ ...props }) {
  return <DropdownMenuPrimitive.Sub data-slot="dropdown-menu-sub" {...props} />;
}

// botón que activa y expande el submenú al pasar el cursor o hacer clic
...
// contenedor flotante para los elementos pertenecientes al submenú
